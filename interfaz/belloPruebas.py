...
def crear_interfaz():
    ...
    buttonBuscaActualizaciones = ctk.CTkButton(root, text="Buscar Actualizaciones El Encino", command=buscarActualizaciones)
    buttonBuscaActualizaciones.pack(pady=10, anchor="w")

    # Crear una etiqueta para el resultado
    global etiqueta_resultado
    etiqueta_resultado = ctk.CTkLabel(root, text="", font=("Arial", 14), text_color=gris_cfe)
